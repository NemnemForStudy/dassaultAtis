...
//			slSelect.add(DecConstants.SELECT_ATTRIBUTE_DECSEQUENTIALNO); // SEQUENTIAL_NO
			...
			// Modify yhShin 20231023 Subcon Decs 추가
			MapList cwpSubConList = null;
			Map<String, Map> cwpSubConMap = null;
			String subconCode1 = null;
			String subconDesc1 = null;
			String subconCode2 = null;
			String subconDesc2 = null;
			...
			for ( String projectId : projectIdList )
			{
				...
				// Modify yhShin 20231023 Subcon Decs 추가
				cwpSubConList = codeJPO.getProjectCodeDetailList(context, projectId, "Sub-Con");
				cwpSubConMap = decListUtil.getSelectKeyDataMapForMapList(cwpSubConList, DecConstants.SELECT_ATTRIBUTE_DECCODE);
				...
				for ( Object obj : workPackageList )
				{
					...
					if ( DecConstants.TYPE_DECCWPTASK.equals(type) )
					{
						...
						// get Subcon1
						// Modify yhShin 20231023 Subcon Decs 추가
						subconCode1 = (String) workPackageMap.get(DecConstants.SELECT_ATTRIBUTE_DECSUBCONNO);
						if ( cwpSubConMap.containsKey(subconCode1) ) 
						{
							subconDesc1 = (String) cwpSubConMap.get(subconCode1).get(DecConstants.SELECT_DESCRIPTION);
						}
						else
						{
							subconDesc1 = subconCode1;
						}
						// get Subcon2
						// Modify yhShin 20231023 Subcon Decs 추가
						subconCode2 = (String) workPackageMap.get("attribute[decSubConNo2]");
						if ( cwpSubConMap.containsKey(subconCode2) ) 
						{
							subconDesc2 = (String) cwpSubConMap.get(subconCode2).get(DecConstants.SELECT_DESCRIPTION);
						}
						else
						{
							subconDesc2 = subconCode2;
						}
...
//						ifCWPMap.put("ORG_CD2", (String) workPackageMap.get("attribute[decSubConNo2]"));
						ifCWPMap.put("ORG_CD1", subconCode1);
						ifCWPMap.put("ORG_CD2", subconCode2);
						ifCWPMap.put("ORG_NM1", subconDesc1);
						ifCWPMap.put("ORG_NM2", subconDesc2);
