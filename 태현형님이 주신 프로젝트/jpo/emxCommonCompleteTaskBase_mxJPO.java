					...
					if (outStr1 == 0) {
						...
						if (sRouteCompletionAction.equals("Promote Connected Object")) {
							...
							for(int count=0; count<routeContentList.size();count++) {
								...
								if ("FALSE".equals(sIsObjSatisfied)  && !"True".equalsIgnoreCase(isPLMEntity))  {
								...
								if (bPromoteObject == 1) {
									...
									if(currState.equals(sObjCurrent)){
										if("TRUE".equalsIgnoreCase(isPLMEntity)) {
											com.matrixone.apps.common.RouteIRPCContentPromote.changeMaturityIRPCContents(context, physicalId, currState, "Promote");
										}else {
