...
<jsp:useBean id="SCTableBean" class="com.matrixone.apps.framework.ui.decUITableIndented" scope="session"/>
...
SCTableBean = (decUIStructureCompare)structureCompareBean;
...
// 	sessionValueMap = (HashMap)((UIStructureCompare)SCTableBean).getSCCriteria(sTimeStamp);
	sessionValueMap = (HashMap)((decUIStructureCompare)SCTableBean).getSCCriteria(sTimeStamp);
}
...
// 	strReportType = ((UIStructureCompare)SCTableBean).getActiveTabForStructureCompare(sTimeStamp);
	strReportType = ((decUIStructureCompare)SCTableBean).getActiveTabForStructureCompare(sTimeStamp);
}

if(isBPSReport)
{
// 	reportFrame = ((UIStructureCompare)SCTableBean).getFrameForActiveTab(strReportType); 
	reportFrame = ((decUIStructureCompare)SCTableBean).getFrameForActiveTab(strReportType); 
}
...
// 	((UIStructureCompare)SCTableBean).setStructureCompareCriteria(sTimeStamp, hmCompareSelectionMap);
	((decUIStructureCompare)SCTableBean).setStructureCompareCriteria(sTimeStamp, hmCompareSelectionMap);
}
else
{
// 	((UIStructureCompare)SCTableBean).setActiveTabForStructureCompare(sTimeStamp, strReportType);
	((decUIStructureCompare)SCTableBean).setActiveTabForStructureCompare(sTimeStamp, strReportType);
}
