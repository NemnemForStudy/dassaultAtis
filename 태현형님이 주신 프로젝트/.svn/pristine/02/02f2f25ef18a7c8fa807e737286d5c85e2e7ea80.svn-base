<%--  emxCollectionEditDialogFS.jsp   -   FS page for Editing Collection Details
   ...
   decCreateSafetyStaticsDialogFS.jsp
...
<%
  ...
  contentURL.append("decProjectSafetyStaticsCreateDialog.jsp");
  ...
  String PageHeading = "emxProgramCentral.Label.createSafetyStatics";
