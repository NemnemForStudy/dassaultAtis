...
define('DS/decDashBoardProjectSitePhoto/decDashBoardProjectSitePhoto',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashBoardProjectSitePhoto/decDashBoardProjectSitePhoto.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
