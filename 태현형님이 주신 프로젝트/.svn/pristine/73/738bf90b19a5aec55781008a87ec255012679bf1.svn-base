...
String selectExpr = emxGetParameter(request, "selectExpr"); // Added by hslee on 2023.07.18
...
for(int i=0;i<emxTableRowId.length;i++) {
    ...
    {
	    strList.addElement(selectExpr); // Added by hslee on 2023.07.18
    }
    ...
    String strSelectResult = null;
    if ( StringUtils.isNotEmpty(selectExpr) )
    {
	    strSelectResult = (String)resultList.get(selectExpr); // Added by hslee on 2023.07.18
    }
    ...
    PIDValue.append(strContextObjectPhysicalId);
 	// Added by hslee on 2023.07.18 --- [s] 
    if ( StringUtils.isNotEmpty(strSelectResult) )
    {
    	actualValue.append(strSelectResult);
    }
    else
    {
	    actualValue.append(strContextObjectName);
    }
 	// Added by hslee on 2023.07.18 --- [e]
