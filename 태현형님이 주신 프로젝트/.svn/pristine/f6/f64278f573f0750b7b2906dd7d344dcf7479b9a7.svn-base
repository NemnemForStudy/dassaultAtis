...
function getDefaultCategory(){
	var commandName = document.getElementsByClassName("menu text-only active")[0].getAttribute("name");
	var selectedId = document.getElementById("project-combo").options[document.getElementById("project-combo").selectedIndex].id
	console.log(commandName);
	var defaultCategory = commandName.substr(3);
	console.log(defaultCategory);
	//alert(defaultCategory);
	var changeLink = "../common/emxTree.jsp?objectId="+selectedId+"&mode=replace&AppendParameters=true&DefaultCategory="+defaultCategory+"&reloadAfterChange=true";
