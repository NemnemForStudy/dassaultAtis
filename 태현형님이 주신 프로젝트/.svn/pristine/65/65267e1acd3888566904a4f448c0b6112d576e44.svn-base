...
// 		}
		...
		dpCode = (String) trendMap.getOrDefault("DP_CD", "");
		category = dpCode.equalsIgnoreCase("PP") ? (String) trendMap.getOrDefault("CATEGORY", "") : ""; // 2023.10.24. thok Key Q'ty Summary 명칭과 동일하게
		...
		titleExpr += " [" + uom + "]";
		System.out.println(category + " " + (String) trendMap.getOrDefault("KEY_ITEM", ""));
