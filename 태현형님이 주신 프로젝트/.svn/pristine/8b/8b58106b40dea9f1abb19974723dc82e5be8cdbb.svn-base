...
define('decDashBoardProjectMaterialStatus/decDashBoardProjectMaterialStatus',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashBoardProjectMaterialStatus/decDashBoardProjectMaterialStatus.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
