...
define('decDashboardEWPWeeklyReleaseStatus/decDashboardEWPWeeklyReleaseStatus',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardEWPWeeklyReleaseStatus/decDashboardEWPWeeklyReleaseStatus.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
