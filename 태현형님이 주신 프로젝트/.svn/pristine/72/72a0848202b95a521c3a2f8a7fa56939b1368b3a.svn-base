...
<%
	...
	slPhaseParam.add("to[" + DecConstants.RELATIONSHIP_DECIMAGEHOLDER + "|from." + DecConstants.SELECT_ATTRIBUTE_DECIMAGETYPE + "=='Field'].from.id");
 	...
 	<table>
    	...
    	<tr>
       		<td class="label" style="text-align:center;">
       			<div id="imgDiv" style="height: 100%;"></div>
       		</td>
    	</tr>
    	</tbody>
	</table>
