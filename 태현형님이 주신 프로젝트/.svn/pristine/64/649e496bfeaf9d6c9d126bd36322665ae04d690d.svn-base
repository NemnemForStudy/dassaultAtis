...
define('decDashboardKeyQtySummary/decDashboardKeyQtySummary',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        var widgetHost = widget.getValue("widgetHost");
        ...
        WebPage = {
            ...
            getUrl: function () {
				...
				var useUrl = null;
				if ( widgetHost === "" || widgetHost === undefined )
				{
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardKeyQtySummary/decDashboardKeyQtySummary.jsp?isDashboard=true&mode=Summary&pageHeading=emxProgramCentral.Label.KeyQtySummary&projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
