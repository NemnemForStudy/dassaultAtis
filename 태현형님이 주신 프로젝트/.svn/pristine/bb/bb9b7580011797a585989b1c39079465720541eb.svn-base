...
;(function() {	
    ...
    // GJA - take zoom into account for offset calculation
          var currentZoom = 1;
          if ((this.isResizable === undefined || this.isResizable === true) && params && params.element && params.element._jsPlumb && params.element._jsPlumb.instance) {
            var instZoomValue = params.element._jsPlumb.instance.getZoom();
            if (instZoomValue > 0)
          ...
          // GJA end get zoom
			...
			if (this.userDefinedLocation != null) {
				...
				this.lastReturnValue = [ xy[0] + (this.x * wh[0]) + currentZoom* this.offsets[0], xy[1] + (this.y * wh[1]) + currentZoom * this.offsets[1] ];
			}
