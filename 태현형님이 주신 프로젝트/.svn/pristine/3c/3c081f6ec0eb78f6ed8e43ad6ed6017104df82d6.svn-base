<%--  decProjectEnterOrderResultDialogFS.jsp  
...
<%
  ...
  contentURL.append("decProjectEnterOrderResultDialog.jsp");
  ...
  String PageHeading = "emxProgramCentral.ProjectSpace.EnterOrderResult.Label";
