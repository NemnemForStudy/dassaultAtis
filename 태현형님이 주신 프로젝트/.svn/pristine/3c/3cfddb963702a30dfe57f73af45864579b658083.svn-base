...
define('decDashboardPreliminaryIWPReleasePlanSkyline/decDashboardPreliminaryIWPReleasePlanSkyline',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardPreliminaryIWPReleasePlanSkyline/decDashboardPreliminaryIWPReleasePlanSkyline.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
