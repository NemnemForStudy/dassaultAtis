...
define('decDashBoardProjectMaterialStatusItemGroup/decDashBoardProjectMaterialStatusItemGroup',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashBoardProjectMaterialStatusItemGroup/decDashBoardProjectMaterialStatusItemGroup.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
