...
%>
	<html>
		...
		<%}%>		
			...
			<div id='divPageBody'>
				<iframe name='checkinFrame' id='checkinFrame' src="decCommonDocumentCheckinCharsetUTF8.jsp" width='100%' height='100%' frameborder='0' border='0' scrolling="auto"></iframe>      						
			</div>
			<div id="divPageFoot">
					...
					<tr>
					  <td class="buttons" align="right">
						<table border="0" cellspacing="0">
						  <tr>
							<td>
									<a href="javascript:this.frames['checkinFrame'].checkinDecFile()" class="button"><button class="btn-primary" type="button">
