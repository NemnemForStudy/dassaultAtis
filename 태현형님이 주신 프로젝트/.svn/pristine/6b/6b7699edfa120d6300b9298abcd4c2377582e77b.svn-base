<%--  decemxComponentsPeopleDetails.jsp   -   Display Details of BusinessUnits 
...
%>
  ...
  <tr>
      <td class="label"><emxUtil:i18n localize="i18nId">emxComponents.PersonDetails.EnglishName</emxUtil:i18n></td>
      <%--//XSSOK--%>
