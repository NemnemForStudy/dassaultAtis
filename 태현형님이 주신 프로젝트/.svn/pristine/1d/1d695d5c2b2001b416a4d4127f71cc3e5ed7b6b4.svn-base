...
public class decMaterial_mxJPO {
	...
	public List<ExportConfig> getMaterialStatusExportConfig() throws Exception{
		try {
			...
			configList.add(new ExportConfig("ITEM_STS_NM","ITEM_STS_NM")); 
			configList.add(new ExportConfig("NEXT_STEP_NM","NEXT_STEP_NM")); 
			configList.add(new ExportConfig("MAT_STS_NM","MAT_STS_NM")); 
			configList.add(new ExportConfig("OBJ_TP_CD","OBJ_TP_CD"));  
			configList.add(new ExportConfig("OFW_QTY","OFW_QTY")); 
	...
	public MapList getCWPSummaryDynamicQtyColumn(Context context, String[] args) throws Exception{
		try {
			...
			final String GROUP_HEADER_BOM = "BOM";
			...
			switch (Discipline) {
			case "PP":
				columnList.add( generateCWPSummaryColumnMap("TOT_ITEM_QTY", PROP_PREFIX + "Qty", SUITE_KEY, GROUP_HEADER_ISO, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("ALLOC_ITEM_QTY", PROP_PREFIX + "Allocation", SUITE_KEY, GROUP_HEADER_ISO, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_ITEM_QTY", PROP_PREFIX + "InStock", SUITE_KEY, GROUP_HEADER_ISO, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_ITEM_RT", PROP_PREFIX + "InStockPercent", SUITE_KEY, COLUMN_TYPE_PROGRAM_HTML_OUTPUT, "decMaterial", "getProgressBarList", GROUP_HEADER_ISO, null, false, DYNAMIC_COLUMN_NAME) );
				
				columnList.add( generateCWPSummaryColumnMap("TOT_BM_QTY", PROP_PREFIX + "Qty", SUITE_KEY, GROUP_HEADER_BOM, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("ALLOC_BM_QTY", PROP_PREFIX + "Allocation", SUITE_KEY, GROUP_HEADER_BOM, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_BM_QTY", PROP_PREFIX + "InStock", SUITE_KEY, GROUP_HEADER_BOM, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_BM_RT", PROP_PREFIX + "InStockPercent", SUITE_KEY, COLUMN_TYPE_PROGRAM_HTML_OUTPUT, "decMaterial", "getProgressBarList", GROUP_HEADER_BOM, null, false, DYNAMIC_COLUMN_NAME) );
				
				columnList.add( generateCWPSummaryColumnMap("TOT_WGT", PROP_PREFIX + "Qty", SUITE_KEY, GROUP_HEADER_WEIGHT, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				...
				columnList.add( generateCWPSummaryColumnMap("TOT_DI_QTY", PROP_PREFIX + "Qty", SUITE_KEY, GROUP_HEADER_WELDING_DI, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("ALLOC_DI_QTY", PROP_PREFIX + "Allocation", SUITE_KEY, GROUP_HEADER_WELDING_DI, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_DI_QTY", PROP_PREFIX + "InStock", SUITE_KEY, GROUP_HEADER_WELDING_DI, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_DI_RT", PROP_PREFIX + "InStockPercent", SUITE_KEY, COLUMN_TYPE_PROGRAM_HTML_OUTPUT, "decMaterial", "getProgressBarList", GROUP_HEADER_WELDING_DI, null, false, DYNAMIC_COLUMN_NAME) );
			...
			case "ME":
				...
				columnList.add( generateCWPSummaryColumnMap("INV_PACKAGE_RT", PROP_PREFIX + "InStockPercent", SUITE_KEY, COLUMN_TYPE_PROGRAM_HTML_OUTPUT, "decMaterial", "getProgressBarList", GROUP_HEADER_PACKAGE, null, false, DYNAMIC_COLUMN_NAME) );
			...
			case "IC": case "EL":
				...
				columnList.add( generateCWPSummaryColumnMap("TOT_LM_QTY", PROP_PREFIX + "Qty", SUITE_KEY, GROUP_HEADER_CABLE_LM, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("ALLOC_LM_QTY", PROP_PREFIX + "Allocation", SUITE_KEY, GROUP_HEADER_CABLE_LM, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_LM_QTY", PROP_PREFIX + "InStock", SUITE_KEY, GROUP_HEADER_CABLE_LM, NUMBER_FORMAT, false, DYNAMIC_COLUMN_NAME) );
				columnList.add( generateCWPSummaryColumnMap("INV_LM_RT", PROP_PREFIX + "InStockPercent", SUITE_KEY, COLUMN_TYPE_PROGRAM_HTML_OUTPUT, "decMaterial", "getProgressBarList", GROUP_HEADER_CABLE_LM, null, false, DYNAMIC_COLUMN_NAME) );
