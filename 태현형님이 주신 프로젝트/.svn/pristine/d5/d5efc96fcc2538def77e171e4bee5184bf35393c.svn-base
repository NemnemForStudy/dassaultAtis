...
<%
	...
	String sImageType = (String) emxGetParameter(request, "imageType");
...
//  End:R207:PRG:R207:Bug:368948
    ...
    emxCommonDocumentCheckinData.put("imageType", sImageType);
...
//          Added for Bug #371651 starts
    ...
    if(DecStringUtil.isNotEmpty(sImageType)){
    	forwardURL = "decCommonDocumentCheckinDialogFS.jsp";
    }
