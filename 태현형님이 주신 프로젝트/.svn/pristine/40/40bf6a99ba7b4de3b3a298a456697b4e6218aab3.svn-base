...
<%
	...
	if(DecStringUtil.isNotEmpty(sObjectId)){
		sbURL.append("/3dspace/common/decDashboardemxIndentedTable.jsp?program=decInterfaceDV:findVPDocumentObject&table=decVPDocumentStatusTable&editLink=false&selection=multiple&sortColumnName=Name&submitAction=refreshCaller&HelpMarker=emxhelpprogramlist&sortDirection=ascending&slideinFilter=true&freezePane=DOC_NO,REVISION&pageSize=300");
