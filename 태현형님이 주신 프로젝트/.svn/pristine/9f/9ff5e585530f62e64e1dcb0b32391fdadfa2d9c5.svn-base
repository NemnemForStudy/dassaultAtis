    	...
    	function (embeded3DSpace, WAFData, dashboardCommon, PlatformAPI) {
	        ...
	        var myWidget = {
				...
				init: function() {
					...
					embeded3DSpace.setQueryStr("jsp=../programcentral/decMaterialAllocationStatus.jsp&hierarchyFrameSelection=single&filterParam=codeMaster:Sub-Con&Discipline=" + widget.getValue("Discipline"));
