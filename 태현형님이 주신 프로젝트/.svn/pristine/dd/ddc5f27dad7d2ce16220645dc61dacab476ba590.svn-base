...
<%
    ...
    url.append("./decCodeMasterImportExcelProcess.jsp?folder=");
    url.append(sFolder);
    String sURL =  url.toString(); 
    System.out.println("decCodeMasterImportExcel Folder:"+sFolder);
...
function importExcelData(){
    ...
    var url = "./decCodeMasterExcelInvoke.jsp?folder=<%=sFolder%>";
