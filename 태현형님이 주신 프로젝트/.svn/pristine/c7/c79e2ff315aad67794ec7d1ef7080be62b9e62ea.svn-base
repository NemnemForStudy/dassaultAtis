...
define('decDashBoardProjectSafetyStatics/decDashBoardProjectSafetyStatics',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
             ...
             */
            getUrl: function () {
				if(widget.getValue('projectCode')){var useUrl = widget.getUrl();
				useUrl = useUrl.substring(0, useUrl.indexOf('3dspace'));
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashBoardProjectSafetyStatics/decDashBoardProjectSafetyStatics.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
