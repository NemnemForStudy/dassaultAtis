...
<%
	...
	slPhaseParam.add("to[" + DecConstants.RELATIONSHIP_DECIMAGEHOLDER + "|from." + DecConstants.SELECT_ATTRIBUTE_DECIMAGETYPE + "=='Plat Plan'].from.id");
     	...
     	<tr>
    		...
    		for(Object o : mlPhase) {
    			...
    			if(DecStringUtil.equalsAnyIgnoreCase(sWBSType, "Unit")){
	    			...
	    			paramMap.put("imageType", "Plat Plan");
