...
(function( factory ) {
	if ( typeof define === "function" && define.amd && !window.ignoreRequire ) {
...
$.widget( "ui.droppable", {
	...
	_create: function() {
		...
		var myProportions, //NWT 07/14/2014 - changed this variable from "porportions" to "myProportions" to prevent naming problems with this.proportions() function below
			o = this.options,
			accept = o.accept;
