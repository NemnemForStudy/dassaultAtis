define("BTWWLibrairies/jsmpeg/jsmpeg.min", [], function() {
    var JSMpeg = {
        Player: null,
        VideoElement: null,
        BitBuffer: null,
    ...
    JSMpeg.Player = (function() {
        ...
        var Player = function(url, options) {
            ...
            if (options.video !== false) {
                ...
                this.renderer =
                    !options.disableGl && JSMpeg.Renderer.WebGL.IsSupported() ? new JSMpeg.Renderer.WebGL(options) : new JSMpeg.Renderer.Canvas2D(options);
    ...
    JSMpeg.Source.WebSocket = (function() {
        ...
        WSSource.prototype.start = function() {
            ...
            this.progress = 0;
            this.established = false;
            this.socket = new WebSocket(this.url);//, this.options.protocols || null); //UM5 : Issue with Chrome
        ...
        TS.prototype.parsePacket = function() {
            ...
            if (adaptationField & 1) {
                ...
                if (payloadStart && this.bits.nextBytesAreStartCode()) {
                    ...
                    pi = this.pesPacketInfo[streamId];
                    if (pi) {
                        var pts = 0;
                        if (ptsDtsFlag & 2) {
                            this.bits.skip(4);
