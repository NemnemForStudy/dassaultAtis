...
define('decDashboardConstructionKPI/decDashboardConstructionKPI',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardConstructionKPI/decDashboardConstructionKPI.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
