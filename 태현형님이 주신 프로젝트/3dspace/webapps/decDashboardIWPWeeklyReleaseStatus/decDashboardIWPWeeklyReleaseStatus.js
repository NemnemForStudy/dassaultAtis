...
define('decDashboardIWPWeeklyReleaseStatus/decDashboardIWPWeeklyReleaseStatus',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardIWPWeeklyReleaseStatus/decDashboardIWPWeeklyReleaseStatus.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
