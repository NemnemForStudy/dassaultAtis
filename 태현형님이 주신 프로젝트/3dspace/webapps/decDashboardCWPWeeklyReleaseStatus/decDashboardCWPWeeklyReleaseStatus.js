...
define('decDashboardCWPWeeklyReleaseStatus/decDashboardCWPWeeklyReleaseStatus',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardCWPWeeklyReleaseStatus/decDashboardCWPWeeklyReleaseStatus.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
