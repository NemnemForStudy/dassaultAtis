...
function executeWidgetCode() {
    require([
        ...
        "DS/decDashboardCommon/decDashboardEmbeded3DSpace",
                ...
                if (tableMode === "FindAndExpand" || tableMode === "FindOnly") {
                    UM5ToolsWS.find({
                        data: {
                            ...
                            findParams: widget.getValue("findParams") + " &projectCode=" + widget.getValue('projectCode'),
                      //      where: widget.getValue("whereExpRoot") ? widget.getValue("whereExpRoot") + " && to[Task Deliverable].from.attribute[decProjectCode] == " + widget.getValue('projectCode') : "to[Task Deliverable].from.attribute[decProjectCode] == " + widget.getValue('projectCode')
