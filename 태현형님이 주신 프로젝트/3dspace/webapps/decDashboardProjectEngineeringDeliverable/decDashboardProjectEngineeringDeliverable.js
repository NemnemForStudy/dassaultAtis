...
define('decDashboardProjectEngineeringDeliverable/decDashboardProjectEngineeringDeliverable',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardProjectEngineeringDeliverable/decDashboardProjectEngineeringDeliverable.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
