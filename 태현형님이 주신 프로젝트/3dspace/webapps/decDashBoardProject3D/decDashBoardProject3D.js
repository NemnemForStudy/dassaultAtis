...
define('DS/decDashBoardProject3D/decDashBoardProject3D',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashBoardProject3D/decDashBoardProject3D.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
