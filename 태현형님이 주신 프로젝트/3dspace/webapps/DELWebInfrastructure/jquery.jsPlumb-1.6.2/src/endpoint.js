    ...
    var _makeConnectionDragHandler = function(placeholder, _jsPlumb) {
        ...
        return {
            drag : function() {
                ...
                var _ui = jsPlumb.getUIPosition(arguments, 1 /*_jsPlumb.getZoom()*/);
...
// END TYPE
        ...
        this.setAnchor = function(anchorParams, doNotRepaint) {
           ...
           // GJA, account for resizable flag on the endpoint
            this.anchor.isResizable = true;
            if(params && params.endpoint && (params.endpoint.length >=2))
              this.anchor.isResizable = params.endpoint[1].resizable;

          // GJA end account for resizable
