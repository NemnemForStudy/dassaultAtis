    	...
    	function (embeded3DSpace, WAFData, dashboardCommon, PlatformAPI) {
	        ...
	        var myWidget = {
				...
				init: function() {
					...
					embeded3DSpace.setQueryStr("jsp=../programcentral/decProjectKeyQtyReportHeaderFS.jsp&isDashboard=true&hierarchyFrameSelection=single&mode=Overall&pageHeading=emxProgramCentral.Label.OverallKeyQuantity&projectCode=" + widget.getValue("projectCode"));
				},
				load: function() {
					embeded3DSpace.load();
				},
