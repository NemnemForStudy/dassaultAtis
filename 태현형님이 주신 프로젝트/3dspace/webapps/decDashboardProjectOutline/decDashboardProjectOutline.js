...
define('DS/decDashboardProjectOutline/decDashboardProjectOutline',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardProjectOutline/decDashboardProjectOutline.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
