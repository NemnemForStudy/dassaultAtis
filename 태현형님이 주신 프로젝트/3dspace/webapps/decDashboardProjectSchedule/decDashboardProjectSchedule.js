...
define('DS/decDashboardProjectSchedule/decDashboardProjectSchedule',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardProjectSchedule/decDashboardProjectSchedule.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
