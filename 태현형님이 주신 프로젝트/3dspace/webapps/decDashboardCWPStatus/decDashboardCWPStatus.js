...
define('decDashboardCWPStatus/decDashboardCWPStatus',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardCWPStatus/decDashboardCWPStatus.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
