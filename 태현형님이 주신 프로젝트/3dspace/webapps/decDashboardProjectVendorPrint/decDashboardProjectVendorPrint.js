...
define('decDashboardProjectVendorPrint/decDashboardProjectVendorPrint',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardProjectVendorPrint/decDashboardProjectVendorPrint.jsp?projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
