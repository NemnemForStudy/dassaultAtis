...
define('decDashboardKeyQtyTrend/decDashboardKeyQtyTrend',
    [
        // UWA
        'UWA/Core',
        'UWA/Utils',
    ...
    function (
        ...
        WebPage = {
            ...
            getUrl: function () {
                ...
                var urlProtocol, url = Utils.parseUrl(useUrl + "3dspace/webapps/decDashboardKeyQtyTrend/decDashboardKeyQtyTrend.jsp?isDashboard=true&mode=Trend&pageHeading=emxProgramCentral.Label.KeyQuantityTrend&projectCode=" + widget.getValue('projectCode')),
                    urlResult = '',
