...
<%
	...
	String sImageType = emxGetParameter(request, "imageType");
...
try
{
        ...
        if (strListDeleteSize > 0)
        {
            ...
            Image image = new Image(object.getInfo(context, "to[" + DecConstants.RELATIONSHIP_DECIMAGEHOLDER + "|from." + DecConstants.SELECT_ATTRIBUTE_DECIMAGETYPE + "=='" + sImageType + "'].from.id", false));
            ...
            imageHolderId = object.getInfo(context, "to[" + DecConstants.RELATIONSHIP_DECIMAGEHOLDER + "|from." + DecConstants.SELECT_ATTRIBUTE_DECIMAGETYPE + "=='" + sImageType + "'].from.id", false);
            ...
            if (imageHolderId == null || "null".equals(imageHolderId) || "".equals(imageHolderId) )
            {
                if (traveseAttValue.equalsIgnoreCase("No") || (traveseAttValue.equalsIgnoreCase("Yes") && isPrimaryFromAltPath.equalsIgnoreCase("Yes"))) {
                    DomainObject imageObject = DomainObject.newInstance(context, DecConstants.TYPE_DECIMAGEHOLDER);
                    ContextUtil.pushContext(context);
                    imageObject.createAndConnect(context, DecConstants.TYPE_DECIMAGEHOLDER, DecConstants.RELATIONSHIP_DECIMAGEHOLDER, object, false);
