...
System.out.println("frameName--"+frameName); // mod by cmg
...
//targetWindow = window.document.getElementById("pagecontent").contentWindow;
//targetWindow = window.parent.document.getElementById("rightSlideIn").querySelector('iframe[name="slideInFrame"]');
targetWindow = getTopWindow().document.getElementById("rightSlideIn").querySelector('iframe[name="slideInFrame"]');
debugger;	
...
// 폼 찾기위해 추가함.
if (vfieldNameActual==null && vfieldNameDisplay==null) {
	var vfieldNameActual=targetWindow.contentWindow.document.getElementById("pagecontent").contentWindow.document.forms[0]["decOwner"];
	var vfieldNameDisplay=targetWindow.contentWindow.document.getElementById("pagecontent").contentWindow.document.forms[0]["decOwnerDisplay"];
	}
