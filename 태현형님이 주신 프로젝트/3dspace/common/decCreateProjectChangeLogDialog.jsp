<%--  emxCollectionsEditDialog.jsp   - Dialog page to take input for editing a Collection.
   ...
   Created By Choimingi 2023-05-26
--%>
...
// 	String inputStringDate = now.format(outputFormatter); //형식을 db에 맞게 바꿔준다
...
<%
    ...
    editURL.append("&inputDate="+XSSUtil.encodeForURL(context,formatedNow));
%>
<!-- \\XSSOK -->
...
<table border="0" width="100%" cellpadding="5" cellspacing="2">
  ...
  <tr>
<%--   	<td class="inputField" name="inputDate"><%=inputDbDate.toString()%> --%>
  	<td class="inputField" name="inputDate"><%=formatedNow%>
  	</td>
  </tr>
  <tr>
