...
<!-- //XSSOK -->
<!-- Modified by jhlee on 2023-06-08 jsp:include밑에 주석이 들어갈 경우 에러가 나서 [e]를 위로 옮김 -->
<!-- Modified by hslee on 2023.05.11 --- [s] -->
...
<!-- Modified by hslee on 2023.05.11 --- [e] -->
<jsp:include page="decemxToolbar.jsp" flush="true"> <jsp:param name="toolbar" value="<%=strToolbar%>"/> <jsp:param name="helpMarker" value="<%=strHelpMarker%>" />
