...
%>
   ...
   <TABLE class="list" width="100%">
        ...
        <TR class="even">
          <TD>
             <INPUT type="radio" name="objectview" id="objectview" value="default" />  <emxUtil:i18n localize="i18nId">emxFramework.ObjectCompare.PivotOption1</emxUtil:i18n> &nbsp; &nbsp;  &nbsp;
             <INPUT type="radio" name="objectview" id="objectview" value="pivot" checked <%--기존 코드<%=compare.pivot?"checked":""%> --%>/>  <emxUtil:i18n localize="i18nId">emxFramework.ObjectCompare.PivotOption2</emxUtil:i18n>
          </TD>
        </TR>
   </TABLE>
