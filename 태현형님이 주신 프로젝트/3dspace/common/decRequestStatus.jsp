...
<%
	...
	try{
		...
		StringList projectAdmin = new StringList();
		...
		if(mode.equalsIgnoreCase("delete")){
			...
			DomainObject object = new DomainObject(objectId);
			projectAdmin = object.getInfoList(context, "to["+DecConstants.RELATIONSHIP_DECPROJECTREQUESTREL+"].from.from[Member|" 
    				+ DecConstants.SELECT_ATTRIBUTE_DECPROJECTMEMBERROLE + "=='PIM'].to." + DecConstants.SELECT_NAME,false);
			
			if(!(projectAdmin.contains(context.getUser()) || context.isAssigned("decSystemAdmin"))){
