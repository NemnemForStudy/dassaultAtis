...
String sNoCodeMasterMessage = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource_ko", context.getLocale(), "emxFramework.DecCreateDetail.NoCodeMasterFail");
