...
// Added by hslee on 2023.09.14 --- [s]
function getViewMyCompanyMemberURL() {
	jQuery("iframe#content").attr("src", emxUIConstants.VIEWMYCOMPANYURL + "&DefaultCategory=People");
}
// Added by hslee on 2023.09.14 --- [e]