...
function setProductLabel(brandName, appName){
	var expLabel = "";
	appName = "<span style='font-family:Myriad-Pro;line-height: 1.3;font-weight:bold;'><a href='/3dspace' style='text-decoration-line: none;'><span style='color: rgba(255, 255, 255);'>ALL </span><span style='color: rgba(105, 179, 227);'>BARO</span></a></span>";
...
function getTopWindow(){
    ...
    while(oTop && oTop.parent != oTop && oTop.name != "mxPortletContent" && typeof oTop.topMostEnoviaWindow  == "undefined"){
        ...
        try {
			const parentHref = oTop.parent.location.href;
			if ( parentHref.indexOf("/3ddashboard/") > -1 )
			{
				break;
			}
		}catch(e){
