...
function chartHeightSet(){
	$('#container').css('height', (document.documentElement.clientHeight - 110) + 'px');
	$('#container2').css('height', (document.documentElement.clientHeight - 110) + 'px');
}
</script>
<link rel="stylesheet" href="../webapps/UIKIT/UIKIT.css" type="text/css" />
<body onload="chartHeightSet();">
       	<div style="text-align: right; margin: 10px;">
		<h4 style="margin-top:0px; margin-bottom:0px;">
       	CWP Plan&emsp;<a href=JavaScript:window.open("emxTree.jsp?DefaultCategory=decCwpPlanList&objectId=<%=sObjectId%>");><img src="images/iconActionNewWindow.png" border="0"></a>
       	&emsp;&emsp;
