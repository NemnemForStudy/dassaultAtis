...
//							: message);
	...
	public static Map<String,String> compareStartFinishDate(String startDate, String finishDate){
		Map<String,String> resultMap = new HashMap<String,String>();
		if(DecStringUtil.isAllEmpty(startDate, finishDate)) {
			resultMap.put("Action", DecConstants.SYMB_NA);
			resultMap.put("Message", DecConstants.SYMB_NA);
		}else if(DecStringUtil.isNotEmpty(finishDate) && DecStringUtil.isEmpty(startDate)){
			resultMap.put("Action", "Error");
			resultMap.put("Message", " Needed. cannot only enter ");
		}else{
			return compareStartFinishDate(DecDateUtil.autoChangeLocalDate(startDate), DecDateUtil.autoChangeLocalDate(finishDate));
		}
		return resultMap;
	}

	public static Map<String,String> compareStartFinishDate(Date startDate, Date finishDate){
		Map<String,String> resultMap = new HashMap<String,String>();
		if(startDate.after(finishDate)) {
			resultMap.put("Action", "Error");
			resultMap.put("Message", " cannot be after the ");
		}else {
			resultMap.put("Action", DecConstants.SYMB_NA);
			resultMap.put("Message", DecConstants.SYMB_NA);
		}
	...
	public static Map<String,String> compareStartFinishDate(LocalDate startDate, LocalDate finishDate){
		Map<String,String> resultMap = new HashMap<String,String>();
